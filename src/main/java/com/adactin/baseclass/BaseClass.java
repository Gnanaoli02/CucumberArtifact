		...
		try {
			if (browsername.equalsIgnoreCase("chrome")) {
				System.setProperty("webdriver.chrome.driver",
						"C:\\Users\\saravanan\\eclipse-workspace\\CucumberArtifact\\src\\test\\java\\com\\adactin\\drivers\\chromedriver.exe");
				driver = new ChromeDriver();

			} 
			else if (browsername.equalsIgnoreCase("ie")) {
				System.setProperty("webdriver.ie.driver",
						"C:\\Users\\saravanan\\eclipse-workspace\\CucumberArtifact\\src\\test\\java\\com\\adactin\\drivers\\IEDriverServer.exe");
